      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ backgroundColor: '#1C1C1A', padding: 'clamp(24px, 4vw, 40px)' }}>
            <div>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.1rem', fontWeight: 600, color: '#E8E0D0', margin: '0 0 14px' }}>
                What do you need?
              </h3>
            ...
            <div style={sectionDivider}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: 'DM Mono, monospace', fontSize: '0.7rem', color: 'rgba(232,224,208,0.3)', marginTop: '4px' }}>
                <span>1</span><span>20</span>
              </div>
            </div>

            <div style={sectionDivider}>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.1rem', fontWeight: 600, color: '#E8E0D0', margin: '0 0 14px' }}>Add-ons</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  <label key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }} onClick={item.toggle}>
                    ...
                    <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.72rem', color: '#8FAF9F', whiteSpace: 'nowrap' }}>{item.price}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div style={sectionDivider}>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.1rem', fontWeight: 600, color: '#E8E0D0', margin: '0 0 14px' }}>How fast do you need this?</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  <label key={opt.value} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }} onClick={() => setTimeline(opt.value)}>
                    ...
                    {opt.price && <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.72rem', color: '#8FAF9F', whiteSpace: 'nowrap' }}>{opt.price}</span>}
                  </label>
                ))}
              </div>
            </div>
          ...
          <div style={{ backgroundColor: '#FDFAF6', padding: 'clamp(24px, 4vw, 40px)', display: 'flex', flexDirection: 'column', gap: '14px', borderLeft: '1px solid rgba(212,201,176,0.35)' }}>
            <div>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.3rem', fontWeight: 600, color: '#1C1C1A', margin: '0 0 6px' }}>Estimated Cost</h3>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', color: '#1C1C1A', opacity: 0.45, margin: 0 }}>See how UnderCurrent compares</p>
            </div>
            <div style={costCard}>
              <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.68rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#1C1C1A', opacity: 0.45, marginBottom: '6px' }}>Typical agency charges minimum</div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', fontWeight: 700, color: '#1C1C1A', lineHeight: 1.05, letterSpacing: '-0.02em' }}>${agencyCost.toLocaleString()}</div>
              <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.76rem', color: '#1C1C1A', opacity: 0.4, marginTop: '4px' }}>+ Long timelines &amp; ongoing retainer fees</div>
            </div>
            <div style={costCard}>
              <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.68rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#1C1C1A', opacity: 0.45, marginBottom: '6px' }}>Regular freelancer charges minimum</div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', fontWeight: 700, color: '#1C1C1A', lineHeight: 1.05, letterSpacing: '-0.02em' }}>${freelancerCost.toLocaleString()}</div>
              <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.76rem', color: '#1C1C1A', opacity: 0.4, marginTop: '4px' }}>+ Inconsistent quality &amp; no AI expertise</div>
            </div>
            <div style={{ padding: '22px 24px', borderRadius: '16px', background: 'linear-gradient(135deg, #8FAF9F 0%, #6B7C4A 100%)' }}>
              <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.68rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.72)', marginBottom: '6px' }}>With UnderCurrent</div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2rem, 3.5vw, 2.8rem)', fontWeight: 700, color: '#fff', lineHeight: 1.05, letterSpacing: '-0.02em' }}>${price.toLocaleString()}</div>
              <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', color: 'rgba(255,255,255,0.85)', marginTop: '4px' }}>Save time, money &amp; get real results</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <>
      ...
      <div style={{ backgroundColor: '#F7F3ED', overflowX: 'hidden' }}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            <h1 style={{ lineHeight: 1, margin: 0 }}>
              ...
              <span style={{ display: 'block', fontFamily: 'DM Sans, sans-serif', fontSize: 'clamp(3rem, 7vw, 7rem)', fontWeight: 700, letterSpacing: '-0.03em', color: 'rgba(143,175,159,0.9)', lineHeight: 1.05, marginTop: '0.08em' }}>
                Calculator.
              </span>
            </h1>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 'clamp(1rem, 1.5vw, 1.15rem)', fontWeight: 300, color: 'rgba(232,224,208,0.65)', lineHeight: 1.7, maxWidth: '44ch', marginTop: '2rem' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
                    <span style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2.4rem, 5vw, 3.5rem)', fontWeight: 600, color: '#8FAF9F', lineHeight: 1 }}>$</span>
                    <input
                      type="number"
                      ...
                      placeholder="75"
                    />
                    <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.78rem', color: '#1C1C1A', opacity: 0.4, alignSelf: 'flex-end', paddingBottom: '6px' }}>/hr</span>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: '8px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                    <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.3rem', fontWeight: 600, color: '#1C1C1A', margin: 0 }}>
                      Hours per week on…
                    </h3>
                    <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: '#1C1C1A', opacity: 0.35 }}>0 – 20 hrs</span>
                  </div>
                  <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', color: '#1C1C1A', opacity: 0.45, margin: '0 0 16px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', color: '#1C1C1A',
              ...
              <div style={{ position: 'sticky', top: '96px' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '28px' }}>
                    ...
                    <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.4rem', fontWeight: 600, color: '#1C1C1A', margin: 0 }}>Your savings</h3>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '28px' }}>
                    {[
                      ...
                      <div key={label} className={`metric-card ${hasValues ? 'active' : ''}`}>
                        <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#8FAF9F', marginBottom: '4px' }}>
                          {label}
                        </div>
                        <div style={{
                          fontFamily: 'Cormorant Garamond, serif',
                  ...
                  {hasValues && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '14px 16px', borderRadius: '12px', background: 'rgba(143,175,159,0.08)', border: '1px solid rgba(143,175,159,0.2)' }}>
                      ...
                      <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.84rem', color: '#1C1C1A', opacity: 0.7 }}>
                  ...
                  {!hasValues && (
                    <div style={{ textAlign: 'center', padding: '16px' }}>
                      <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.84rem', color: '#1C1C1A', opacity: 0.35, margin: 0, fontStyle: 'italic' }}>
                ...
                {hasValues && (
                  <div style={{ backgroundColor: '#FDFAF6', border: '1px solid rgba(212,201,176,0.65)', borderRadius: '24px', padding: 'clamp(20px, 3vw, 32px)', boxShadow: '0 4px 32px rgba(28,28,26,0.07), 0 1px 4px rgba(28,28,26,0.04)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px' }}>
                      ...
                      <span style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#6B7C4A' }}>Cost breakdown</span>
                    </div>
                    ...
                    <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: '#1C1C1A', opacity: 0.3, margin: '16px 0 0', letterSpacing: '0.04em' }}>
        ...
        <section style={{
          ...
          <div style={{ position: 'relative' }}>
            <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.7rem', letterSpacing: '0.18em', color: '#8FAF9F', textTransform: 'uppercase', marginBottom: '16px' }}>
              Ready to get it back?
            </p>
            <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 600, color: '#E8E0D0', margin: '0 0 24px', letterSpacing: '-0.02em' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center' }}>
            {[
              ...
              <a key={link.href} href={link.href} style={{
                ...
                <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.72rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#6B7C4A', marginBottom: '6px' }}>
                  {link.label}
                </div>
                <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.84rem', color: 'rgba(28,28,26,0.65)', lineHeight: 1.55 }}>
                  {link.desc}
                </div>
              </a>
            ))}
