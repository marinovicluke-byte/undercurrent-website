    ...
    <div style={{ backgroundColor: '#F7F3ED', overflowX: 'hidden' }}>
        ...
        <div className="max-w-7xl mx-auto relative">
          <Reveal>
            ...
            <div className="flex flex-wrap gap-4">
              <a href={CTA_HREF} target="_blank" rel="noopener noreferrer" className="btn-sage-hero" style={{ fontSize: '0.95rem', padding: '0.9rem 2.5rem' }}>
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <section style={{ position: 'relative', zIndex: 10, maxWidth: '900px', margin: '0 auto', padding: '0 1.5rem 5rem' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center' }}>
          {[
            { href: '/audit', label: 'Free Business Audit', desc: 'Get a personalised breakdown of where automation fits in your business.' },
            { href: '/roi', label: 'ROI Calculator', desc: 'See exactly how much time and money automation could save you.' },
            { href: '/case-study', label: 'Case Studies', desc: 'Real businesses, real results from AI automation.' },
            { href: '/process', label: 'How We Work', desc: 'Our step-by-step process from audit to full automation.' },
            { href: '/about', label: 'About UnderCurrent', desc: 'The story behind our AI automation studio.' },
            { href: '/contact', label: 'Get in Touch', desc: 'Ready to automate? Start the conversation.' },
          ].map(link => (
            <a
              key={link.href}
              href={link.href}
