...
const steps = [
  {
    ...
    body: 'A focused conversation to understand where your business leaks time and money. We identify the workflows that are costing you most — before anything is built.',
  ...
  },
  {
    ...
    headline: 'You only pay from what we save.',
    body: 'No packages. No flat rates. We price by the value we unlock for your business. If we save you $200k, we take a fraction. If we save you $20k, we price accordingly.',
