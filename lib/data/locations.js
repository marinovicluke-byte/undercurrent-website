...
export const LOCATIONS = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: 'AI automation in Melbourne is the build-and-maintain layer that takes repetitive admin off your team, designed around how Melbourne small businesses run across the CBD, inner-north suburbs like Fitzroy and Brunswick, the bayside corridor, and the eastern growth ring. UnderCurrent Automations maps where 15 to 25 hours a week are leaking, then ships fixed-price systems on Xero, HubSpot, n8n and the tools you already pay for. Most builds go from first call to live system in 14 days, all delivered in AEDT business hours.',

    metroDetail: {
      heading: 'How AI automation runs across greater Melbourne.',
      body: 'Greater Melbourne spans roughly 50 kilometres from Werribee in the west to Lilydale in the east, and small-business density splits cleanly. Professional services cluster in the CBD, South Yarra, Richmond and Fitzroy. Trade businesses operate out of the inner north and outer growth corridors. Clinics and allied-health practices spread evenly across the metro. We run every build remotely, in AEDT business hours, with weekly check-ins and a working system at handover. For Melbourne trades, lead-response automation has to handle Hipages plus Google enquiries plus direct calls before a competitor in the next suburb picks up. For Melbourne consultants, the admin layer between signed engagement letter and onboarded client is where the hours go. Buyers agents working Toorak, Hawthorn and Brighton run a different shape again, vendor matching, suburb-watchlist nurturing and inspection scheduling, and we build to that shape too.',
      regulators: [
