...
export const SERVICES = [
...

  {
    ...
    bluf: 'Sales automation is the infrastructure layer that captures every lead, qualifies it, routes it to the right rep, sequences follow-up and books meetings without anyone remembering to act. UnderCurrent builds it end-to-end on the CRM you already use, so pipeline keeps moving while your team focuses on closing.',
...

  {
    ...
    bluf: 'Content automation is the production pipeline that turns a brief, a voice note or a transcript into published articles, social posts and newsletters across every channel you use. UnderCurrent builds it on your existing publishing stack, so expertise gets distributed consistently without a weekly writing session that never happens.',
...

  {
    ...
    bluf: 'Personal system automation is the assistant layer that sits over your inbox, calendar and task tools. It triages messages, drafts replies, books meetings, extracts tasks and surfaces what matters, without sending anything you have not approved. UnderCurrent builds it on Gmail, Outlook, Notion or the tools you already run on.',
...

  {
    ...
    bluf: 'Finance automation is the system that handles invoicing, payment follow-up, expense capture and cash flow reporting without manual data entry. UnderCurrent builds it on Xero, QuickBooks, MYOB or your existing accounting stack, so invoices go out on time, overdue payments chase themselves and your books stay reconciled while you run the business.',
...

  {
    ...
    bluf: 'Inbound lead management is the system that catches every enquiry from ads, forms and direct contact, sends an instant acknowledgement, qualifies the lead and triggers follow-up before a competitor replies. UnderCurrent builds it for Melbourne service businesses so paid leads stop slipping between inboxes and phone notes.',
...

  {
    ...
    metaTitle: 'AI Strategy & Training Australia — Roadmaps and Team Workshops | UnderCurrent',
    metaDescription: 'Vendor-neutral AI roadmaps, tool selection and hands-on team training. UnderCurrent helps Australian small businesses adopt ChatGPT, Claude and custom AI without wasting months.',
...

  {
    ...
    metaTitle: 'Custom Integrations Australia — n8n, Make, Zapier, Direct APIs | UnderCurrent',
    metaDescription: 'Connect every tool in your stack. UnderCurrent builds custom integrations on n8n, Make, Zapier and direct APIs so data flows where it should — wired and built to last.',
