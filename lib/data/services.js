...
export const SERVICES = [
...

  {
    ...
    internalLinks: [
      ...
      { label: 'Robin Search', path: '/seo-ai-visibility' },
      { label: 'Sales Automation', path: '/sales-automation' },
...

  {
    ...
    metaTitle: 'Robin Search — UnderCurrent\'s Search Ecosystem',
    metaDescription: 'Robin Search is UnderCurrent Automations\' search ecosystem: SEO, AEO (AI search), PPC, and Maps and Places — wired together to win Google rankings, ChatGPT citations and local visibility for Australian small businesses.',

    heroPill: 'Robin Search',
