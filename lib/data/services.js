...
export const SERVICES = [
  {
    ...
    // SEO
    metaTitle: 'Customer Experience Automation',
...

  {
    ...
    metaTitle: 'Personal System Automation',
...

  {
    ...
    metaTitle: 'Inbound Lead Management',
...

  {
    ...
    internalLinks: [
      ...
      { label: 'Search ecosystem', path: '/seo-ai-visibility' },
      { label: 'Sales Automation', path: '/sales-automation' },
      { label: 'Inbound Lead Management Melbourne', path: '/inbound-lead-management-melbourne' },
      { label: 'Small Business Website Design: Build One That Ranks', path: '/blog/small-business-website-design', kind: 'Article' },
      { label: 'Build a Website for Small Business: 2026 AU Guide', path: '/blog/build-a-website-for-small-business', kind: 'Article' },
      { label: 'Wix vs Squarespace: Pick One, or Skip Both', path: '/blog/wix-vs-squarespace', kind: 'Article' },
    ],
...

  {
    ...
    seedQueries: [
      ...
      'local search ranking australia',
    ],
    index: '08',
    label: 'SEARCH ECOSYSTEM',
    displayName: 'Search ecosystem',

    accentColor: '#6A8DAD',

    metaTitle: "UnderCurrent's Search Ecosystem",
    metaDescription: 'SEO, AEO, PPC and Maps and Places, wired together to win Google rankings, ChatGPT citations and local visibility for Australian small business.',

    heroPill: 'Search ecosystem',

    deliversHeadline: 'One search ecosystem. Google, ChatGPT, Maps, and paid — all working together.',
    whatWeDeliver: [
      ...
      'Answer engine optimisation (AEO) retrofit: BLUF paragraphs, question-led H2s, verbatim-citable FAQ blocks',
      ...
      'Google Business Profile, Maps and Places setup, local citations, and review generation for suburb-level search',
      'PPC campaign management on Google Ads with conversion tracking, lead-form assets, and remarketing wired to your CRM',
      'Monthly reporting on Google rankings, AI search citations, paid performance, and organic pipeline attribution',
    ],
    ...
    internalLinks: [
      ...
      { label: 'Sales Automation', path: '/sales-automation' },
      { label: 'Website Design', path: '/website-design' },
      { label: 'How to Rank in ChatGPT Search (2026 Guide)', path: '/blog/how-to-rank-in-chatgpt-search', kind: 'Article' },
      { label: 'How to Measure AI Search Visibility (and Fix It)', path: '/blog/how-to-measure-ai-search-visibility', kind: 'Article' },
      { label: 'How to Choose the Best AEO Agency in Australia', path: '/blog/best-aeo-agencies-australia', kind: 'Article' },
      { label: 'What Google Ads Cost an Australian Small Business', path: '/blog/google-ads-cost-australian-small-business', kind: 'Article' },
      { label: 'Google Maps SEO: Rank in the Local Pack', path: '/blog/google-maps-seo', kind: 'Article' },
      { label: 'SEO for Electricians: Rank Higher in Local Search', path: '/blog/seo-for-electricians', kind: 'Article' },
      { label: 'SEO for Dentists: Win Local and AI Search', path: '/blog/seo-for-dentists', kind: 'Article' },
      { label: 'SEO for Mortgage Brokers in Australia', path: '/blog/seo-for-mortgage-brokers-australia', kind: 'Article' },
    ],

    bluf: "UnderCurrent Automations' search ecosystem combines classic SEO, answer engine optimisation (AEO), Google AI Overview tuning, PPC management, and Google Maps and Places into one engine, so Australian small businesses earn rankings, citations, and local visibility from the same body of work, instead of paying four agencies to half-do the job.",
    ...
    pricingTiers: [
      { name: 'Foundation',    priceFrom: 'AUD $1,000/mo',  tag: 'Entry',     desc: 'Technical SEO + schema fixes, light content cadence (2 articles + 2 service/location pages per month). Built for businesses just getting started in AI search.' },
      { name: 'Local + PPC',   priceFrom: 'AUD $2,800/mo',  tag: 'Most common', desc: 'Full Local SEO including Google Ads / PPC alongside organic. 8 articles + 4 service/location pages per month, GBP + Apple Business + FAQ schema. The most common starting tier for committed AU SMBs.' },
      { name: 'National',      priceFrom: 'AUD $9,500/mo',  tag: 'Premium',   desc: 'Multi-location, multi-vertical scope with active link building (4-6 high-DR/mo), 18 articles + 8 service pages per month, up to 10 GBP locations, bi-weekly strategy.' },
    ],
  },
