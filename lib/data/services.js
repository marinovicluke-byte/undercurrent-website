...
export const SERVICES = [
...

  {
    ...
    metaDescription: "UnderCurrent Automations' search ecosystem combines SEO, AEO (AI search), PPC, and Maps and Places, wired together to win Google rankings, ChatGPT citations and local visibility for Australian small businesses.",
