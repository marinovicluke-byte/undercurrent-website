...
export const SERVICES = [
  {
    ...
    metaDescription: 'Turn every new client into a loyal advocate. UnderCurrent Automations builds automated onboarding, check-in, review, and referral systems for Melbourne small businesses.',
...

  {
    ...
    metaTitle: 'Sales Automation Melbourne — More Pipeline, Same Team',
    metaDescription: 'Stop losing leads to slow follow-up. UnderCurrent Automations builds automated lead capture, outreach, and CRM pipeline systems that keep your sales moving around the clock.',
...

  {
    ...
    metaTitle: 'Content Automation Melbourne — Publish More, Write Less',
    metaDescription: 'Stop spending 10 hours a week on content that never gets done. UnderCurrent Automations builds content pipelines that take a brief or recording and publish across every channel automatically.',
...

  {
    ...
    metaTitle: 'Personal System Automation Melbourne — Inbox and Calendar, Handled',
    metaDescription: 'Stop losing 3 to 4 hours a day to email and admin. UnderCurrent Automations builds AI-powered inbox, calendar, and task management systems that give Melbourne business owners their time back.',
...

  {
    ...
    metaTitle: 'Finance Automation Melbourne — Stop Chasing Invoices',
    metaDescription: 'Automate your invoice creation, payment follow-up, expense tracking and cash flow reporting. UnderCurrent Automations builds finance automation for Melbourne small businesses.',
...

  {
    ...
    metaTitle: 'Inbound Lead Management Melbourne — Stop Losing Paid Enquiries',
    metaDescription: 'Melbourne tradespeople and service businesses: stop losing paid leads. UnderCurrent Automations builds done-for-you inbound lead management systems that capture, qualify and follow up every enquiry until it is booked.',
...

  {
    ...
    internalLinks: [
      { label: 'Surface Discovery', path: '/surface-discovery' },
      { label: 'Content Automation', path: '/content-automation' },
      { label: 'AI Automation Melbourne', path: '/ai-automation-melbourne' },
      { label: 'Sales Automation', path: '/sales-automation' },
      { label: 'Website Design', path: '/website-design' },
...

  {
    ...
    metaTitle: 'Front End Experience Australia — Websites, Portals, Dashboards | UnderCurrent',
    metaDescription: 'Marketing sites, client portals, booking systems and dashboards built on Next.js and wired to your back-end stack. UnderCurrent builds front-end experiences that convert.',
...

  {
    ...
    metaTitle: 'SEO, AEO and GEO Australia — Rank Everywhere Buyers Search | UnderCurrent',
    metaDescription: 'Classic SEO plus answer-engine and generative-engine optimisation. UnderCurrent earns Google rankings and citations in ChatGPT, Claude and Perplexity for Australian small businesses.',

    heroPill: 'Surface & Discovery',

    deliversHeadline: 'Ranking in Google, cited in ChatGPT. Everywhere your buyers look.',
    whatWeDeliver: [
      'Technical SEO audit: crawl, index, Core Web Vitals, structured data, internal linking',
      'Entity-rich page architecture — topic clusters, pillar pages and interlinked hubs',
      'AEO content retrofitting: answer-first structure, FAQ schema, and BLUF paragraphs',
      'GEO optimisation: authoritative, citable content that ChatGPT and Perplexity surface',
      'JSON-LD stack: Organization, LocalBusiness, Service, FAQPage, Person, Article, BreadcrumbList',
      'llms.txt and llms-full.txt generation so AI crawlers read your site cleanly',
      'Local SEO: Google Business Profile, citations, reviews, location pages',
      'Monthly reporting on rankings, answer-engine citations and organic pipeline',
    ],
    ...
    industries: [
      {
        label: 'Service Businesses',
        headline: 'Rank where your ICP is already searching.',
        copy: 'Consultants, advisors, agencies, trades. We build topic clusters around the questions your buyers type into Google and ask ChatGPT, then interlink everything into a pillar architecture that compounds month on month.',
      },
      {
        label: 'SaaS and Product Companies',
        headline: 'Own the category, not just the brand term.',
        copy: 'Startups and SaaS teams who need inbound, not just paid. We build category-defining content, comparison pages and use-case hubs that ChatGPT, Claude and Perplexity cite — and that Google ranks for the queries that actually convert.',
      },
      {
        label: 'Local and Multi-location',
        headline: 'Found by the suburb, not just the postcode.',
        copy: 'Melbourne and Sydney service businesses with multiple service areas. We build out Google Business Profile, local landing pages and review systems so you show up in Maps, in Overviews and in direct enquiries.',
      },
    ],
    ...
    faqs: [
      {
        ...
        a: 'Answer-engine optimisation targets the models behind ChatGPT, Claude and Perplexity. SEO targets Google. AEO content is answer-first, entity-dense and written so a language model can extract a verbatim citation. SEO earns a ranking; AEO earns a mention. We build for both because buyers now use both.',
      },
      {
        q: 'What is GEO?',
        a: 'Generative-engine optimisation is the newer term for the same territory as AEO — getting your content cited inside generative answers on ChatGPT, Google AI Overviews and Perplexity. Some practitioners use GEO and AEO interchangeably; we use GEO for the ranking side of AI search and AEO for the direct-answer side.',
      },
      {
        q: 'How long before rankings move?',
        a: 'Technical fixes and on-page changes typically move in 4 to 8 weeks. Topical authority — ranking for a cluster of queries, not just one — takes 4 to 6 months of consistent publishing. AEO citations can happen within days of a page being indexed, but compound properly over the same 3 to 6 month horizon.',
      },
      {
        q: 'Do you write the content yourselves?',
        a: 'Yes. We draft briefs, write the content, run it through our humanizer pass and publish. You review, we refine. AI assists the research and outline phase, but every page ships with a named human author and the voice that matches your brand — not generic spun prose.',
      },
      {
        q: 'What tools do you use to track AI search citations?',
        a: 'AhrefsBot logs, Semrush, Ahrefs, manual prompt testing across ChatGPT, Claude and Perplexity, and server-side analytics for the AI crawler user agents (GPTBot, PerplexityBot, ClaudeBot, Googlebot). We report monthly on rankings, citations and organic pipeline attribution.',
      },
      {
        q: 'Will you touch our existing site content?',
        a: 'Yes, if rewriting is the fastest lift. Most established sites have ranking pages that leak conversions because they are not answer-first or entity-rich. We audit, prioritise by traffic value, and retrofit. New pillar content fills the gaps the audit surfaces.',
      },
    ],

    ctaHeadline: 'Rank in Google. Get cited in ChatGPT. Both.',
    ctaCopy: 'Book a free 30-minute call. We will audit your current organic visibility — Google rankings, AEO citations, GBP — and show you the highest-leverage moves for the next 90 days.',

    internalLinks: [
      { label: 'SEO & AI Visibility', path: '/seo-ai-visibility' },
      { label: 'Content Automation', path: '/content-automation' },
      { label: 'AI Automation Melbourne', path: '/ai-automation-melbourne' },
      { label: 'Sales Automation', path: '/sales-automation' },
    ],

    bluf: 'Surface discovery is the discipline that earns your business visibility across every channel buyers search on: Google, ChatGPT, Perplexity, Claude, Google AI Overviews and local Maps. UnderCurrent combines classic SEO, answer-engine optimisation and generative-engine optimisation into one compounding system so your buyers find you whichever tool they use first.',

    pipelineStages: [
      { n: '01', label: 'Audited',     sub: 'Crawl, index, schema, entity gaps' },
      { n: '02', label: 'Architected', sub: 'Topic clusters, pillar hubs, internal links' },
      { n: '03', label: 'Written',     sub: 'Answer-first, BLUF, FAQ schema' },
      { n: '04', label: 'Structured',  sub: 'JSON-LD stack, llms.txt, sitemaps' },
      { n: '05', label: 'Published',   sub: 'Google, GBP, LinkedIn, syndication' },
...

  {
    ...
    metaTitle: 'AI Strategy & Training Australia — Roadmaps and Team Workshops',
    metaDescription: 'Vendor-neutral AI roadmaps, tool selection and hands-on team training. UnderCurrent Automations helps Australian small businesses adopt ChatGPT, Claude and custom AI without wasting months.',

    heroPill: 'AI Strategy & Training',

    deliversHeadline: 'An AI roadmap your team will actually use, not a deck that sits in Drive.',
    whatWeDeliver: [
      'Current-state assessment: tool stack, data maturity, policy gaps, team literacy',
      '90-day AI roadmap with prioritised use cases ranked by ROI and feasibility',
      'Vendor-neutral tool selection across ChatGPT, Claude, Gemini, Copilot, Cursor',
      'Policy and governance framework: data handling, model access, prompt logging',
      'Team workshops tailored by role — sales, ops, finance, marketing, leadership',
      'Prompt libraries and role-specific playbooks your team keeps using after we leave',
      'One-on-one executive coaching for founders and leadership teams',
      'Monthly office hours for 3 months after handover — questions answered, drift corrected',
    ],

    industriesCopy: 'If your team is using ChatGPT on the side but nothing has been adopted at the business level — or you have spent on tools nobody uses — this is the layer we run before any automation work begins.',
    industries: [
      {
        label: 'Founders and Leadership',
        headline: 'A 90-day plan, not a six-figure consultancy engagement.',
        copy: 'Small-business owners and leadership teams under 50 staff. We run a half-day workshop, map your highest-leverage use cases, and hand you a roadmap you can execute with existing people. No PowerPoint theatre, no open-ended retainer.',
      },
      {
        label: 'Operations and Admin Teams',
        headline: 'From AI-curious to AI-confident in a week.',
        copy: 'Ops managers, admin leads, finance teams. We run role-specific workshops on ChatGPT, Claude, Copilot and Notion AI — real workflows, real data, real policies. Your team leaves with prompt libraries they wrote themselves and will actually use.',
      },
      {
        label: 'Sales and Marketing Teams',
        headline: 'Stop treating AI as a toy. Start using it as a lever.',
        copy: 'Sales leaders, marketing directors, BDRs. We train teams on lead research, outreach, proposal drafting, content ideation and competitor analysis with AI. The goal is 5 to 10 hours back per person per week, not a demo of every tool.',
      },
    ],

    processHeadline: 'Assess, plan, train. Then we stay for 3 months.',

    comparisonCopy: 'Most businesses have had a ChatGPT Enterprise pitch, a Microsoft Copilot demo, and a consultancy one-pager — and nothing changed.',
    comparisonRows: [
      { label: 'Vendor-neutral tool recommendations',            uc: true,  manual: false, generic: false, agency: false },
      { label: 'Workshops tailored to role, not generic intro',  uc: true,  manual: false, generic: false, agency: true  },
      { label: 'Policy and governance framework included',       uc: true,  manual: false, generic: false, agency: true  },
      { label: 'Delivered in weeks, not multi-quarter programs', uc: true,  manual: true,  generic: true,  agency: false },
      { label: 'Post-engagement office hours for 3 months',      uc: true,  manual: false, generic: false, agency: false },
      { label: 'Priced for small businesses, not enterprise',    uc: true,  manual: true,  generic: true,  agency: false },
    ],
    comparisonColumns: ['UnderCurrent', 'Figuring It Out Internally', 'Vendor Training', 'Big-4 Consultancies'],

    faqs: [
      {
        q: 'Do you train on specific tools or general AI literacy?',
        a: 'Both, in the right order. We start with general literacy so the team understands the difference between ChatGPT, Claude, Gemini and Copilot. Then we go deep on the two or three tools that actually fit your stack and budget. Role-specific hands-on work, not a tour of every vendor.',
      },
      {
        q: 'Are you vendor-aligned with any AI company?',
        a: 'No. We are not a reseller. We pay for our own ChatGPT Pro, Claude Max, Cursor and Copilot seats and recommend based on fit. Sometimes the answer is a $20/month ChatGPT Team plan; sometimes it is a self-hosted Ollama setup. We recommend what works, not what earns commission.',
      },
      {
        q: 'What does a typical engagement look like?',
        a: 'A 2-week assessment followed by a 3-day workshop series and a written 90-day roadmap. The assessment includes interviews with 5 to 8 team members, a tool audit and a data-maturity review. Workshops run in-person in Melbourne or remotely for other locations, with recordings for async reviews.',
      },
      {
        q: 'Will you also build the automations you recommend?',
        a: 'If you want us to, yes — our automation services cover sales, content, finance and personal systems. But the strategy engagement stands alone. Many clients take the roadmap, execute internally or with a preferred agency, and come back to us only for specific builds.',
      },
      {
        q: 'What about data privacy and compliance?',
        a: 'We include a data-handling framework in every engagement: what goes into public AI, what needs enterprise contracts (Claude Enterprise, ChatGPT Enterprise, Azure OpenAI), and what should stay on-prem. Australian Privacy Act, GDPR and industry-specific requirements (legal, health, finance) are covered in the policy draft.',
      },
      {
        q: 'How do I know it worked?',
        a: 'We define 3 to 5 measurable outcomes at the start — hours saved per role, output volume, error reduction, cost per lead — and review at 30, 60 and 90 days. If the team is not using the tools after 90 days, we have not done our job. Most engagements see 5 to 10 hours per person per week reclaimed.',
      },
    ],

    ctaHeadline: 'Adopt AI without wasting a quarter.',
    ctaCopy: 'Book a free 30-minute call. We will walk through your current AI usage — what is working, what is not — and sketch what a focused 90-day program would look like for your business.',
    ...
    bluf: 'AI Strategy & Training is the engagement that turns curiosity into adoption. UnderCurrent Automations runs vendor-neutral assessments, builds a 90-day roadmap ranked by ROI, and delivers role-specific workshops on ChatGPT, Claude, Copilot and Cursor — then stays for three months of office hours so the team actually uses what they learned.',

    pipelineStages: [
      { n: '01', label: 'Assessed',   sub: 'Tools, data, policy, literacy' },
      { n: '02', label: 'Prioritised', sub: 'Use cases ranked by ROI and fit' },
      { n: '03', label: 'Planned',     sub: '90-day roadmap, tool shortlist' },
      { n: '04', label: 'Trained',     sub: 'Role-specific workshops, hands-on' },
      { n: '05', label: 'Governed',    sub: 'Policy, data-handling, access control' },
      { n: '06', label: 'Supported',   sub: 'Monthly office hours, drift correction' },
    ],
    ...
    pricingTiers: [
      { name: 'Workshop', priceFrom: 'from AUD $2,500',  tag: 'Single session',    desc: 'A half-day role-specific workshop for a team of up to 15. Prompt libraries, playbooks and recording included. Good entry point before a full engagement.' },
      { name: 'Roadmap',  priceFrom: 'from AUD $5,000',  tag: 'Assessment + plan', desc: 'Full assessment, 90-day roadmap, tool selection, two workshops and a written policy draft. The standard small-business engagement.' },
      { name: 'Program',  priceFrom: 'Contact for quote', tag: 'Team-wide',        desc: 'Roadmap plus role-specific workshops for up to four teams, executive coaching, and three months of monthly office hours. Fits 20 to 100-person businesses.' },
    ],
  },

  {
    ...
    metaTitle: 'Custom Integrations Australia — n8n, Make, Zapier, Direct APIs',
    metaDescription: 'Connect every tool in your stack. UnderCurrent Automations builds custom integrations on n8n, Make, Zapier and direct APIs so data flows where it should — wired and built to last.',

    heroPill: 'Custom Integrations',

    deliversHeadline: 'If two tools should talk to each other and don\'t, that is what we fix.',
    whatWeDeliver: [
      'Workflow builds on n8n (self-hosted or cloud), Make and Zapier',
      'Direct API integrations in Node.js or Python when a no-code platform will not do',
      'Webhook plumbing: receive, transform, route and retry with full audit trails',
      'OAuth and API-key management across every vendor your workflows touch',
      'Multi-step agent systems using OpenAI, Anthropic, and your business data',
      'Error handling and alerting — Slack, email or PagerDuty when a workflow breaks',
      'Documentation: every integration has a diagram, a runbook and a maintainer',
      'Monthly monitoring retainer available for workflows that matter to revenue',
    ],

    industriesCopy: 'If you have a stack that should be a system — a CRM, an accounting tool, a job-management app, an email platform — but each one is an island, this is the service that joins them up.',
    industries: [
      {
        label: 'Operations-Heavy Businesses',
        headline: 'Stop pasting data between tools.',
        copy: 'Trades, logistics, field services, manufacturing. Every tool works on its own; nothing talks. We wire job-management, accounting, CRM, SMS and calendar so a job flows end-to-end without a human re-typing the same data four times.',
      },
      {
        label: 'Digital Teams and SaaS',
        headline: 'The integration your SaaS vendor would not build.',
        copy: 'Product, growth and RevOps teams. Stripe to HubSpot with custom segmentation, Notion to Slack with approval flows, your internal tool to the vendor that should have shipped the integration already. We build what the roadmap never will.',
      },
      {
        label: 'AI-Powered Workflows',
        headline: 'Agents that act, not just answer.',
        copy: 'Teams running early AI automations — lead enrichment, content drafting, email triage, research — that need to scale. We build multi-step agent systems on n8n and direct APIs that actually take action in your CRM, inbox or database.',
      },
    ],

    processHeadline: 'Scope, build, document, monitor.',
    ...
    faqs: [
      {
        ...
        a: 'Zapier for simple one-to-one triggers between popular apps. Make when a workflow has branching, loops and 5+ steps and cost matters. n8n when you want self-hosting, full JavaScript in nodes, or to avoid per-task fees at scale. We recommend based on your usage pattern and budget, not vendor preference.',
      },
      {
        q: 'Do I need to host n8n myself?',
        a: 'No — n8n Cloud works for most use cases. Self-hosting makes sense when you hit high volume, need data residency in Australia, or want unlimited executions. We set up either one: n8n Cloud, n8n on Hetzner, n8n on Railway, or on your existing infrastructure.',
      },
      {
        q: 'What happens when an API changes or breaks?',
        a: 'Every workflow ships with error routing and alerting — Slack, email or PagerDuty. For workflows that touch revenue, our monthly monitoring retainer covers detection, diagnosis and fix within a defined SLA. For one-off builds, we hand over documentation and a runbook so your team or any other dev can repair it.',
      },
      {
        q: 'Can you build AI agents, not just integrations?',
        a: 'Yes. Many of our integrations now include an AI layer — a GPT-4 call inside an n8n workflow, a Claude-powered research step, a multi-agent system that handles inbound leads. We use OpenAI, Anthropic and Cohere APIs directly and wire them into your tools rather than relying on generic AI-in-a-box platforms.',
      },
      {
        q: 'What does a typical integration cost?',
        a: 'A single-flow integration on n8n or Make runs AUD $1,500 to $4,000 depending on complexity. A multi-system workflow with branching, AI steps and error handling is AUD $4,000 to $12,000. Direct API builds in Node.js or Python are project-priced. We scope before committing, never open-ended.',
      },
      {
        q: 'Do you build it, or teach my team to build it?',
        a: 'Either. Most clients want us to build, document and hand over, then maintain it themselves or on our monthly retainer. Some clients want workshops first — we teach the tool, then build the hard integrations alongside them. Training is often bundled with the AI Strategy & Training engagement.',
      },
    ],

    ctaHeadline: 'Connect the stack. Stop the duplicate data entry.',
    ctaCopy: 'Book a free 30-minute call. We will map the tools in your stack, find the integration gaps costing you hours every week, and show you what the wired-up version looks like.',
    ...
    bluf: 'Custom integrations are the plumbing that turns a stack of disconnected tools into a working system. UnderCurrent Automations builds on n8n, Make, Zapier and direct APIs — including AI agent orchestration with OpenAI and Anthropic — so data flows where it should, errors get caught, and every workflow ships with a diagram, a runbook and a maintainer.',
