...
export const PRICING_TIERS = [
  {
    ...
    cta: { label: 'Book a Call', href: 'https://cal.com/luke-marinovic-aqeosc/30min?tier=starter' },
  },
  {
    ...
    cta: { label: 'Book a Call', href: 'https://cal.com/luke-marinovic-aqeosc/30min?tier=growth' },
    featured: true,
  },
  {
    name: 'Done-With-You',
    ...
    cta: { label: 'Book a Call', href: 'https://cal.com/luke-marinovic-aqeosc/30min?tier=dwy' },
  },
]
