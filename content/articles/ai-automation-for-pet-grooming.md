...
When we audited grooming businesses, the best-reviewed salon in its pack still couldn't crack the local pack. Here is the snapshot that reframed how we think about automation for groomers.

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 170" role="img" aria-label="Audited Chelsea grooming business: 70 reviews, 5.0 star rating, GBP score 55 out of 100, zero top-three rankings across 120 local searches"><title>What our grooming audit found</title><desc>A best-reviewed salon still ranking outside the top three</desc><rect width="360" height="170" fill="#121210"/><text x="180" y="28" text-anchor="middle" font-size="14" font-weight="600" fill="#FAF9F5">What Our Grooming Audit Found</text><text x="20" y="62" font-size="11" fill="#D4C9B0">Reviews</text><text x="340" y="62" text-anchor="end" font-size="13" font-weight="600" fill="#8FAF9F">70 · 5.0★</text><line x1="20" y1="72" x2="340" y2="72" stroke="#2E2E2B" stroke-width="1"/><text x="20" y="96" font-size="11" fill="#D4C9B0">GBP score</text><text x="340" y="96" text-anchor="end" font-size="13" font-weight="600" fill="#6A8DAD">55 / 100</text><line x1="20" y1="106" x2="340" y2="106" stroke="#2E2E2B" stroke-width="1"/><text x="20" y="130" font-size="11" fill="#D4C9B0">Top-3 rankings</text><text x="340" y="130" text-anchor="end" font-size="13" font-weight="600" fill="#FAF9F5">0 of 120</text><line x1="20" y1="140" x2="340" y2="140" stroke="#2E2E2B" stroke-width="1"/><text x="180" y="160" text-anchor="middle" font-size="9" fill="#D4C9B0" font-family="ui-monospace,SF Mono,monospace">UnderCurrent Automations · Grooming Audit · 2026</text></svg>
...
action:
  send_sms:
    to: "{{customer.mobile}}"
    body: >
      Hi {{customer.first_name}}, hope {{pet.name}} is looking sharp!
      If you've got 20 seconds, a quick Google review really helps us:
...
Yes, and reminders are the most reliable automation for it. Industry data puts grooming no-shows at 10-15% without automated reminders, dropping to 2-5% once a reminder sequence is running. The pattern that works is a confirmation text when the booking is made, then a reminder the day before with a one-tap reschedule link, so a wobbling customer reschedules instead of vanishing. The reschedule link is the part most salons forget to include.
...
Set up a workflow that sends a review-request SMS a few hours after each completed groom, with your Google review link and a guardrail that skips anyone you've already asked in the last 60 days. Tools like MoeGo and NiceJob do this natively, or you can build it in Zapier or Make. The timing matters, ask while the owner is still happy about how their dog looks. Steady, recent reviews are what local search rewards.
