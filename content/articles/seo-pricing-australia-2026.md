...
<svg width="100%" viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Donut chart: 0 percent fixed retainer, 90 percent range only, 10 percent tiered packages">
  ...
  <desc>0% concrete retainer, 90% range only, 10% tiered packages. n=10.</desc>
  <g transform="translate(180,160)">
    <circle cx="0" cy="0" r="100" fill="none" stroke="#2A2A28" stroke-width="40"/>
    <circle cx="0" cy="0" r="100" fill="none" stroke="#8FAF9F" stroke-width="40" stroke-dasharray="565.5 628.3" transform="rotate(-90)"/>
    <circle cx="0" cy="0" r="100" fill="none" stroke="#D89B6D" stroke-width="40" stroke-dasharray="62.8 628.3" stroke-dashoffset="-565.5" transform="rotate(-90)"/>
    <text x="0" y="6" text-anchor="middle" font-size="24" font-weight="600" fill="#F7F3ED">90%</text>
  </g>
  <g transform="translate(380,120)" font-size="14" fill="#F7F3ED">
    <rect x="0" y="0" width="14" height="14" fill="#8FAF9F"/><text x="22" y="12">Range, 90%</text>
    <rect x="0" y="26" width="14" height="14" fill="#D89B6D"/><text x="22" y="38">Tiered, 10%</text>
    <rect x="0" y="52" width="14" height="14" fill="#5B7A9F"/><text x="22" y="64">Fixed, 0%</text>
  </g>
</svg>
...
- [SEO for buyers agents in Australia](/blog/seo-for-buyers-agents-australia), vertical-specific deep dive
- [Run your own AU SEO self-check](/blog/seo-audit-self-check-australia), same rubric we audited the SERP cohort with
- [AEO vs SEO vs GEO](/blog/aeo-vs-seo-vs-geo), the three optimisation lanes
- [Best AEO agencies in Australia](/blog/best-aeo-agencies-australia), the AI-search agency cohort
- [How AU SEO agencies stack up on AI search](/blog/au-seo-agencies-ai-search-audit), the cohort scoring methodology
- [Plumbers South East Melbourne SEO case study](/case-studies/plumbers-south-east-melbourne-seo), local SEO proof
- [All UnderCurrent case studies](/case-studies), verified-results library
