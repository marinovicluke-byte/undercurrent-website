...
The adoption signal is loud. McKinsey's [State of AI 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) reports 71% of organisations now regularly use generative AI in at least one business function, up from 65% a year earlier, with marketing, sales, service operations and software engineering as the most common surfaces. The job titles changing fastest are the ones spending hours on inbound triage and follow-up.

How it actually runs in practice. An Australian service business plugs Make or n8n into their CRM, email and Twilio. A lead form fires; an OpenAI or Anthropic model reads the enquiry, picks the right service category, drafts a reply in the owner's voice, schedules a follow-up if the lead goes quiet, and only flags a human when the reply needs a price or a site visit. Anthropic frames the design choice cleanly in [Building Effective Agents](https://www.anthropic.com/engineering/building-effective-agents): use a "workflow" with predefined steps when the path is known, an "agent" when the path isn't. Most small-business AI automation today is the workflow shape, and that's the right call. It sits one rung above [Business Process Automation](/glossary/what-is-business-process-automation) and one rung below a full [AI Agent](/glossary/what-is-an-ai-agent). For Australian pricing and a starter workflow, [the plain-English guide](/blog/what-is-ai-automation-australia) goes deeper, and the build side of it is [AI Automation Melbourne](/ai-automation-melbourne).
