...
shortDefinition: Google's free listing that controls how a local business appears in Google Search, Google Maps and the local 3-pack, including name, address, hours, photos and reviews.
category: tool
relatedServices: [/seo-ai-visibility]
relatedTerms: [what-is-local-seo, what-is-seo, what-is-ai-search-optimisation]
sources:
  - { title: "How to manage your Business Profile on Google (Google support)", url: "https://support.google.com/business/answer/7039811" }
  - { title: "Improve your local ranking on Google (Google support)", url: "https://support.google.com/business/answer/7091" }
  - { title: "Local Consumer Review Survey 2026 (BrightLocal)", url: "https://www.brightlocal.com/research/local-consumer-review-survey/" }
faqs:
  - { q: "Is Google Business Profile free?", a: "Yes. GBP is a free Google product, there is no paid tier or subscription. You create and manage it at business.google.com, and Google will never charge you to list your business, add photos, or collect reviews. The only cost is time, keeping fields accurate and responding to reviews." }
  - { q: "Do I need a GBP if I don't have a storefront?", a: "Yes, if you meet customers face to face. Google allows service-area businesses, plumbers, electricians, cleaners, anyone who travels to the customer, to have a profile with their service area shown instead of a street address. You can hide your home address and still show up in local search for every suburb you service." }
  - { q: "Which GBP fields matter most for ranking?", a: "Business category is the most load-bearing field, it tells Google what searches you're relevant for, so picking the primary category precisely matters more than most owners realise. After that: complete and accurate hours, a steady stream of recent reviews, and photos updated at least quarterly. Google's local ranking guidance names relevance, distance and prominence as the three factors, and all three are influenced by how complete and active your profile is." }
